...
int main(int argc, char* argv[])
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //光照
        GLint lightAmbientLoc = glGetUniformLocation(ourShader.ID, "light.ambient");
        GLint lightDiffuseLoc = glGetUniformLocation(ourShader.ID, "light.diffuse");
        GLint lightSpecularLoc = glGetUniformLocation(ourShader.ID, "light.specular");
